<?php
// File: list_competition.php (Versi dengan Pagination Bootstrap)

// ========================================================================
// --- 1. INISIALISASI & PENGAMBILAN DATA ---
// ========================================================================

$page_title = "Daftar Kompetisi - Baking Lovers";
require_once 'php/partials/header.php'; // Memuat header, koneksi DB, dan memulai sesi

$list_activities = [];
$error_message = '';
$activity_type_filter = 'Competition'; // Filter spesifik untuk halaman ini
...
if (isset($conn) && $conn instanceof mysqli) {
    ...
    $items_per_page = 3; // Tampilkan 6 kompetisi per halaman. Anda bisa ubah angka ini.
    ...
    if ($stmt_activities_list) {
        ...
        error_log("Error preparing statement for list_competition: " . $conn->error);
...
<div class="container page-container">
    <h1 class="page-title">Kompetisi & Perlombaan Kami</h1>
    ...
    <div class="activity-list-container">
        ...
        <?php else: ?>
            <p class="message info">Belum ada kompetisi yang diumumkan di halaman ini. Silakan cek kembali nanti.</p>
        <?php endif; ?>
    </div>
