<?php
// File: list_classes.php (Versi dengan Pagination Bootstrap)

$page_title = "Daftar Kelas - Baking Lovers";
require_once 'php/partials/header.php'; // Memuat header, koneksi DB, dan memulai sesi

$list_activities = [];
$error_message = '';
$activity_type_filter = 'Classes'; // Filter spesifik untuk halaman ini
...
if (isset($conn) && $conn instanceof mysqli) {
    ...
    // ========================================================================
    // --- 1. LOGIKA PAGINATION DITAMBAHKAN DI SINI ---
    // ========================================================================

    // A. Tentukan Variabel Pagination
    $items_per_page = 3; // Tampilkan 6 kelas per halaman. Anda bisa ubah angka ini.
    $current_page = isset($_GET['page']) && is_numeric($_GET['page']) ? (int)$_GET['page'] : 1;
    if ($current_page < 1) $current_page = 1;

    // B. Hitung Total Item & Total Halaman
    ...
    if ($stmt_activities_list) {
        ...
        error_log("Error preparing statement for list_classes: " . $conn->error);
...
<div class="container page-container">
    <h1 class="page-title">Pilihan Kelas Kami</h1>
    ...
    <div class="activity-list-container">
        ...
        <?php else: ?>
            <p class="message info">Belum ada kelas yang tersedia di halaman ini. Silakan cek kembali nanti.</p>
        <?php endif; ?>
    </div>
    ...
    <div class="pagination-container mt-5">
        ...
        if ($total_pages > 1) {
            ...
            // Tambahkan parameter type yang ada ke link pagination
