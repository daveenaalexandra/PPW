...
// 3. Hitung total kegiatan yang akan datang
$upcoming_activities_result = $conn->query("SELECT COUNT(*) as total FROM activities WHERE activity_date_start > NOW()");
$upcoming_activities = $upcoming_activities_result->fetch_assoc()['total'];
...
<div class="container page-container">
    ...
    <p class="text-center text-white-50">Selamat datang, <strong><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Admin'); ?></strong>!</p>
            ...
            <div class="admin-widget card-users">
                <div class="widget-inner">
                    ...
                    <div class="widget-text">
                        ...
                        <div class="widget-label">Total Pengguna</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="admin-widget card-orders">
                <div class="widget-inner">
                    ...
                    <div class="widget-text">
                        ...
                        <div class="widget-label">Pesanan Pending</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="admin-widget card-activities">
                <div class="widget-inner">
                    ...
                    <div class="widget-text">
                        <div class="widget-number"><?php echo $upcoming_activities; ?></div>
                        <div class="widget-label">Kegiatan Akan Datang</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="admin-widget card-products">
                 <div class="widget-inner">
                    ...
                    <div class="widget-text">
                        ...
                        <div class="widget-label">Total Jenis Produk</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="text-center mt-3">
        <p class="text-white-50">Gunakan menu dropdown di pojok kanan atas untuk mengelola data.</p>
    </div>
</div>
